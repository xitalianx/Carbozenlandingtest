...
import { RiTimerFill, RiEmotionFill, RiImageFill, RiArrowDownSLine } from 'react-icons/ri';
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        d += uTime * 0.5 * uSpeed;
        vec3 col = vec3(cos(uv * vec2(d, a)) * 0.6 + 0.4, cos(a + d) * 0.5 + 0.5, cos(a + d * 0.5) * 0.5 + 0.5);
    ...
    import('ogl').then(({ Renderer, Program, Mesh, Color, Triangle }) => {
      ...
      program = new Program(gl, {
        ...
        uniforms: {
          uTime: { value: 0 },
          uColor: { value: new Color(0.2, 0.56, 0.7) }, // tonalità simili a #3390B3
      ...
      <div className='container mx-auto'>
        <div className='flex justify-between gap-x-8'>
          ...
          <div className='hidden xl:flex relative'>
            ...
            {/* Iridescence inside hero-bg.png */}
            <div className='absolute -top-1 -right-2 w-[510px] h-[462px]'>
              <div
                ref={iridescenceRef}
