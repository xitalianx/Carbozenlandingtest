...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center xl:bg-secondary-foreground p-1 text-secondary-foreground rounded-[30px] dark:md:bg-secondary',
      className
    )}
    {...props}
  />
